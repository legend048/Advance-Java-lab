...
class mysql_con_and_print_emp{
    public static void main(String args[]){ 
        try{ 
            ...
            System.out.println("Creating Table and Inserting Data:");
            ...
            stmt.executeUpdate("INSERT INTO emp VALUES(2, 'Mahi', 'Employee')");
            rs=stmt.executeQuery("select * from emp");
            while(rs.next()) System.out.println(String.format("ID: %d | Name: %s | Position: %s", rs.getInt(1), rs.getString(2), rs.getString(3)));
